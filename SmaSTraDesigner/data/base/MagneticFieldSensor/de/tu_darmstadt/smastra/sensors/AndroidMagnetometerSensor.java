...
/**
 * An implementation of a sensor for the Magnetic strength
 * @author Tobias Welther
 */
@NeedsOtherClass({ Data3d.class, Abstract3dAndroidSensor.class })
@SensorConfig(displayName = "Magnetic Field Sensor", description = "This measures the magnetic field strength in x,y,z direction.")
public class AndroidMagnetometerSensor extends Abstract3dAndroidSensor {
     ...
     */
    public AndroidMagnetometerSensor(Context context) {
